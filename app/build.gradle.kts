...
val appVersionName = providers.environmentVariable("DUBL_VERSION_NAME").orNull ?: "0.6.2"
val appVersionCode = providers.environmentVariable("DUBL_VERSION_CODE").orNull?.toIntOrNull() ?: 6002000
